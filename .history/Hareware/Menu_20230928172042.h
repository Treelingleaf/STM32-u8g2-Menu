...
/*重写函数*/
void Menu_To_X_Display(ChildMenu *menuitem, ChildMenu *childTemp);                                     /*进入子菜单动画*/
void X_To_Menu_Display(ChildMenu *menuitem, ChildMenu *childTemp);                                     /*返回上一级菜单动画*/
void Creat_Childv2_Menu(ChildMenu *menuitem, ChildMenu *childTemp, uint8_t Picture_Flag, char *Title); /*创建子菜单动画*/
#endif
