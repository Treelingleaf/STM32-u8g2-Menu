...
/*重写函数*/
void Menu_To_X_Display(ChildMenu *menuitem, char *Title, uint8_t child_Flag, uint8_t Picture_Flag);  /*进入子菜单动画*/
void X_To_Menu_Display(ChildMenu *menuitem, char *Title, uint8_t child_Flag, uint8_t Picture_Flag);  /*返回上一级菜单动画*/
void Creat_Childv2_Menu(ChildMenu *menuitem, uint8_t Picture_Flag, char *Title, uint8_t child_Flag); /*创建子菜单动画*/
#endif
