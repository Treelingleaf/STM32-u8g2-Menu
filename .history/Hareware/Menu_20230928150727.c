...
void Show_Menu(Speed_ENUM Speed_choose) // 显示菜单
{
	...
	case 0:
		...
		u8g2_SendBuffer(&u8g2);
		Creat_Child_Menu(MainMenu_Config[0].ChildMenu, "GAME");
		break;
	...
	case 2:
		...
		u8g2_SendBuffer(&u8g2);
		Creat_Child_Menu(MainMenu_Config[2].ChildMenu, "Setting");
		break;
	}
}
...
void Creat_Child_Menu(MainMenu *MainMenu)
{
	...
	display = MainMenu[Picture_Flag].LocaFlag * 48;
