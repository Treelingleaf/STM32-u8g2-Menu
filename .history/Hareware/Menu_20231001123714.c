...
void Creat_Childv2_Menu(ChildMenu *menuitem, uint8_t Picture_Flag, char *Title, uint8_t child_Flag)
{
	...
	{
		Box_Flag = 0;
		Menu_To_X_Display(menuitem, Title, child_Flag, Picture_Flag);
		while (1)
		{
...
*/
void Menu_To_X_Display(ChildMenu *menuitem, char *Title, uint8_t child_Flag, uint8_t Picture_Flag) // 菜单→游戏菜单过渡动画
{
